...
export class AdOdsNaturalKeyToEdorg1687466013005 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "edorg" ADD "odsDbName" character varying`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "edorg" ALTER COLUMN "odsDbName" SET NOT NULL'
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "edorg" DROP CONSTRAINT "UQ_07c5479767d3c27eb0150fee1d9"`
    );
