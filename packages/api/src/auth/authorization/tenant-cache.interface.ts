...
const trueOnlyPrivileges = new Set<TenantBasePrivilege | TenantSbePrivilege>([
  'tenant.role:create',
...
const baseResourcePrivilegesMap: Partial<
...
const sbeResourcePrivilegesMap: Partial<Record<string, TenantSbePrivilege[]>> =
  {
    'tenant.sbe.vendor': [
...
type BasePrivilegeResourceType = keyof typeof baseResourcePrivilegesMap;
type SbePrivilegeResourceType = keyof typeof sbeResourcePrivilegesMap;
type PrivilegeResource = BasePrivilegeResourceType | SbePrivilegeResourceType;
